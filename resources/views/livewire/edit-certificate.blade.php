    ...
    <div class="d-flex">
        <div class="card flex-fill">
            <div class="card-header">
                ...
                <h5 class="card-title">O'quvchini daraja malumotlarini o'zgartirish</h5>
            </div>
            ...
            <form method="post">
                ...
                <div class="row">
                    <div class="col-6 ">
                        ...
                        <div class="card-body">
                            <select class="form-select" wire:model="student_id" name="student_id" >
                                <option disabled selected>O'quvchini tanlang</option>
                                @foreach($students as $id=> $student)
                                    <option @if($certificate->student_id==$id) selected @endif value="{{$id}}">{{$student}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <select wire:change="updateType()" wire:model="type" class="form-select" name="type" id="">
                                ...
                                @foreach(App\Models\Student::TYPES as $id=> $type)
                                    <option @if($certificate->type==$id) selected @endif value="{{$id}}">{{$type}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="card-body">
                            <input wire:model="band" type="number" name="ball" class="form-control"
                                   placeholder="O'quvchini qancha olgan bali" value="{{$certificate->ball}}">
                        </div>
                    </div>
                    @elseif ($Cefr == true)
                    <div class="col-6">
                        ...
                        <div class="card-body">
                            <select  wire:model="degree"  class="form-select" name="degree" id="">
                                ...
                                @foreach(App\Models\Student::DEGREE as $id=> $type)
                                    <option @if($certificate->degree==$id) selected @endif value="{{$id}}">{{$type}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
