                ...
                @foreach ($teachers as $teacher)
                    @if (count($teacher->degrees->ToArray()) == 0)
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="classes-col">
                                {{-- @dd($teacher) --}}
                                <div class="class-thumb"><img src="{{ "$teacher->image" }}" alt="Teacher's class image"
                                ...
                                <div class="class-info">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        @if (array_key_exists($teacher->id, $_SESSION))
                                            <button style="background:none ;color: red; font-size: 30px"> <i
                                                    class="fa-solid fa-heart"></i></button>
                                        @else
                                            <button style="background:none ;color: red; font-size: 30px"
                                                wire:click="likeable({{ $teacher->id }})"> <i
